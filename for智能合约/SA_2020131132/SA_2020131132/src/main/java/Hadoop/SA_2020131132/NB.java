...
public class NB {
	...
	private static String modelFilePath = "D:\\software\\data\\classfinall\\input\\2020131128_moxing.txt";
	private static String testDataFilePath = "D:\\software\\data\\classfinall\\input\\test.txt";
	...
	public static void predictAll() {
		...
		int amount = 0;
		try {
			File file = new File("D:\\software\\data\\classfinall\\output\\2020131128_预测结果.txt"); // 预测结果文件
			file.createNewFile();

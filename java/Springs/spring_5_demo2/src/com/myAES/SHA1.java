...
public class SHA1 {
    ...
    public static void calculateMod_28(String word, String binary) {

        int binaryMessageLength = word.length() * 8 - 8; //the -8 will be taken into account below.
        String endBitLength = calculateMessageLength_28(binaryMessageLength+8); //add back 8 for accuracy
        ...
        createMessageLength_28(binary, onePadded, binaryZeros, endBitLength); //creates the 512 bit message

    }

    public static String calculateMessageLength_28(int bitLength) {
    ...
    public static String createMessageLength_28(String message, String paddedOne, int zeros, String endLength) {
        ...
        String m = printMessage_28(messageBinary.toString());
        m = m.replaceAll("\\s+", "");
    ...
    public static String printMessage_28(String message) {
    ...
    private static String hash_28(int[] z) {
